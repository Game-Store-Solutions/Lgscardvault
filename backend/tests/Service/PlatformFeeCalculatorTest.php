...
final class PlatformFeeCalculatorTest extends TestCase
{
    ...
    public function testUsagePlanChargesFivePercentUntilCap(): void
    {
        $store = (new Store())->setPlanKey('usage');

        self::assertSame(500, $this->calculator->feeDueForCapture($store, 10_000));
    }
    ...
    public function testRemainingCapClampsFee(): void
    {
        ...
        self::assertSame(100, $this->calculator->feeDueForCapture($store, 10_000));
    }
}
