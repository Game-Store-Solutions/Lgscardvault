 ...
 * card in 3D, drifts a glare highlight, and — for foil cards — locks a Holo
 * light-split field to the hotspot. Foils keep a Holo-style idle flow
 * (warp, scale, definition) when the pointer is away. Falls back to a static
