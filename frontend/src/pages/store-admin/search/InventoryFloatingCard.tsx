      ...
      <HoverLift>
        <div className="relative">
          <button
            ...
            className="block w-full overflow-hidden rounded-xl bg-bg shadow-sm ring-1 ring-border transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
          >
            <CardImage
              src={image}
              alt={item.card.name}
        ...
        <div className="mt-2 min-w-0">
          ...
          <div className="mt-1.5 flex flex-wrap gap-1">
            ...
            {item.isFoil ? (
              <span
                className="inline-flex items-center gap-1 rounded-full border border-white/60 px-2 py-0.5 text-[11px] font-bold text-black/80"
